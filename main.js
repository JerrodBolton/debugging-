  ...
  let lower = theShot.toLowerCase();
   ...
   if(lower == "rock"){
        if(randomNumber() == 5){
          ...
          console.log(`You won! I picked scissors`);
        }
          ...
          document.getElementById("printMyShot").innerHTML = "You lost! I picked scissors";
            // This is going to print b/c you want to do three rounds
          document.getElementById("asksTheQuestion").innerHTML = printOut();
          console.log(`You lost! I picked scissors`);
          }
        else if (randomNumber() === 5){
          document.getElementById("printMyShot").innerHTML =  "It's a tie! I picked scissors";
        }
    }
     else if  (lower === "paper"){
      if(randomNumber() > 5){
        //  this is going to print the value I the person won 
        let printMyShot = "you won! I picked rock";
       console.warn(`${ document.getElementById("printMyShot").innerHTML = printMyShot}`);
        // This is going to print b/c you want to do three rounds
        document.getElementById("asksTheQuestion").innerHTML = printOut();
